...
END:VCARD`;
    ...
    link.href = url;
    link.setAttribute("download", "kamal_aurora.vcf");
        ...
        <div className="py-2 lg:py-2 mb-8 lg:mb-2 px-4 mx-auto max-w-screen-md">
          ...
          <div className=" text-white mt-10 space-y-4 ">
            <div className="flex justify-center items-center gap-1">
              <p>Mobile Number: </p>
              <Link href={"tel:971585861086"} className="hover:underline">
                +971 58 586 1086
              </Link>
            </div>
            <div className="flex justify-center items-center gap-1">
